...
def txt_gui():
    ...
    title_label = tk.Label(header_frame,
                           text="📱 Phone Number QR Generator",
    ...
    phone_section = tk.Frame(content_frame, bg="#ffffff", relief="flat", bd=0)
    phone_section.pack(fill="x", pady=(0, 30), padx=20)

    phone_inner = tk.Frame(phone_section, bg="#ffffff")
    phone_inner.pack(padx=25, pady=25)

    label = tk.Label(phone_inner,
    ...
    # Helper text
    helper_text = tk.Label(phone_inner,
    ...
    footer_label = tk.Label(main_frame,
                            text="Scanning the QR code will allow calling the phone number directly",
                            font=("Segoe UI", 10),
                            bg="#f0f4f8",
                            fg="#7f8c8d")
